...
This command halts the virtual machine. All the work done on it is save and the machine is turned off. This acts more as `"turning the power off"`. It’s much slower to stop and start your virtual machine using this command, but it does free up all of your RAM once the machine has been stopped.
