...
This command suspends the virtual machine. Most of the work done is saved and the machine is put into a `sleep mode of sorts`. he machine state is saved and it’s very quick to stop and start the work done.
